...
const Cart = () => {
  ...
  const handleOnline = async () => {
    ...
    const {data} = await axios.post('https://food-ordering-app-ashen.vercel.app/api/checkout', {lineItems})
  ...
  const createOrder = async (data) => {
    try {
      const res = await axios.post("https://food-ordering-app-ashen.vercel.app/api/orders", data);
      if (res.status === 201) {
        dispatch(reset());
