...
const Index = ({ products, orders }) => {
  ...
  const handleDelete = async (id) => {
    try {
      const res = await axios.delete("https://food-ordering-app-l4eo.vercel.app/api/products/" + id)
  ...
  const handleStatus = async (id) => {
    ...
    try {
      const res = await axios.put("https://food-ordering-app-l4eo.vercel.app/api/orders/" + id, { status: currentStatus + 1 })
      setOrderList([
        res.data,
...
export const getServerSideProps = async (ctx) => {
  ...
  const proRes = await axios.get("https://food-ordering-app-l4eo.vercel.app/api/products")
  const orRes = await axios.get("https://food-ordering-app-l4eo.vercel.app/api/orders")
